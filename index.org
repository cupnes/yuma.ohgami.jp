...
** 同人誌/同人作品
   紙版は[[https://ec.toranoana.shop/tora/ec/cot/circle/2UPAeD6Q8475d260d687/all/][とらのあな様]]と一部は[[https://www.beep-shop.com/ec/products/list?name=%25E3%2581%25B8%25E3%2581%25AB%25E3%2582%2583%25E3%2581%25BA%25E3%2582%2593%25E3%2581%25A6][BEEP様]]にて販売中！
...
*** ゲームボーイOS「AMADO」v0.03
    ...
    → *[[https://yohgami.booth.pm/items/2636771][ROM版(BOOTH)(上記画像リンク先と同じ)]]　　　　　[[https://www.beep-shop.com/ec/products/detail/BD-2--6965][カートリッジ版(BEEP)]]　　　　　[[https://ecs.toranoana.jp/tora/ec/item/040030876245/][カートリッジ版(とらのあな)]]*
...
*** ゲームボーイOS「AMADO」で8ビットマシン語入門
    ...
    → *[[https://techbookfest.org/product/5190959769845760][紙/PDF版(技術書典オンラインマーケット)(上記画像リンク先と同じ)]]*
...
*** シェルスクリプトでゲームボーイプログラミング入門
    ...
    → *[[file:GB-Programming-with-Shell-Script.pdf][PDF版(表紙画像リンク先と同じ)]]　　　　　[[file:GB-Programming-with-Shell-Script][HTML版]]　　　　　EPUB版(BOOK☆WALKER)(まだ)*
...
*** バイナリ生成環境「daisy-tools」実験報告
    ...
    → *[[file:Daisy-Tools_Laboratory_Report.pdf][PDF版(表紙画像リンク先と同じ)]]　　　　　[[file:Daisy-Tools_Laboratory_Report][HTML版]]　　　　　EPUB版(BOOK☆WALKER)(まだ)*
...
*** バイナリ生物学入門
    ...
    → *[[file:Intelligent-Life-in-the-Binary.pdf][PDF版(表紙画像リンク先と同じ)]]　　　　　[[file:Intelligent-Life-in-the-Binary][HTML版]]　　　　　EPUB版(BOOK☆WALKER)(まだ)*
...
*** 作って分かる！x86_64機械語入門
    ...
    → *[[file:Introduction-to-x86_64-Machine-Language.pdf][PDF版(表紙画像リンク先と同じ)]]　　　　　[[file:Introduction-to-x86_64-Machine-Language][HTML版]]　　　　　EPUB版(BOOK☆WALKER)(まだ)*
...
*** フルスクラッチで作る!x86_64自作OS パート5 てっとりばやくマルチコア
    ...
    → *[[file:x86_64-Jisaku-OS-5.pdf][PDF版(表紙画像リンク先と同じ)]]　　　　　[[file:x86_64-Jisaku-OS-5][HTML版]]　　　　　EPUB版(BOOK☆WALKER)(まだ)*
...
*** フルスクラッチで作る!x86_64自作OS パート4 ぼくらのイーサネットフレーム!
    ...
    → *[[file:x86_64-Jisaku-OS-4.pdf][PDF版(表紙画像リンク先と同じ)]]　　　　　[[file:x86_64-Jisaku-OS-4][HTML版]]　　　　　EPUB版(BOOK☆WALKER)(まだ)*
...
*** フルスクラッチで作る!x86_64自作OS パート3 システムコールの薄い本
    ...
    → *[[file:x86_64-Jisaku-OS-3.pdf][PDF版(表紙画像リンク先と同じ)]]　　　　　[[file:x86_64-Jisaku-OS-3][HTML版]]　　　　　EPUB版(BOOK☆WALKER)(まだ)*
