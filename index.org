...
#+LANGUAGE: ja
#+SETUPFILE: ~/git/org-html-themes/org/setup/html-theme-bigblow-local.setup
#+OPTIONS: ^:{}
...
** 主な活動場所
   ...
   | 発表資料            | https://speakerdeck.com/cupnes               |
   |                     | https://www.slideshare.net/yarakawa/         |
   | YouTube(過去のデモ) | https://www.youtube.com/@henyapente          |
   | X                   | https://x.com/yohgami                        |
...
** 同人誌/同人作品
   紙版は[[https://ec.toranoana.shop/tora/ec/cot/circle/2UPAeD6Q8475d260d687/all/][とらのあな様]]と一部は[[https://channel.beep-shop.com/products/list?category_id=&name=%E3%81%B8%E3%81%AB%E3%82%83%E3%81%BA%E3%82%93%E3%81%A6][BEEP様]]、[[https://www.melonbooks.co.jp/circle/index.php?circle_id=104561][メロンブックス様]]にて販売中！

   PDF版・HTML版は無料で公開中！　EPUB版は[[https://bookwalker.jp/author/87619/][BOOK☆WALKER様]]にて販売中！

*** セガサターンのことをしゃべって文字起こしした本
    [[file:A-Book-Based-on-a-Monologue-About-the-Sega-Saturn.pdf][file:bbmass-incase-front.jpg]]
    → *[[file:A-Book-Based-on-a-Monologue-About-the-Sega-Saturn.pdf][PDF版(上記画像リンク先と同じ)]]*

    - 初版発行日: 2026/09/13 (第十四回技術書同人誌博覧会)
    - タイトルの通り、セガサターンの事をしゃべって文字起こしした本です。
    - 内容としては、既刊で所々書いたものも含め、私が面白いと思うセガサターンの技術的ネタをまとめたものです。

*** 人間OS v0.1.0
    | [[https://techbookfest.org/product/gbpm4sLL2xUsuKyxZcE5cJ][file:hos010-photo.jpg]] | [[https://techbookfest.org/product/gbpm4sLL2xUsuKyxZcE5cJ][file:hos010_cover.png]] |
    → *[[https://techbookfest.org/product/gbpm4sLL2xUsuKyxZcE5cJ][PDF版(技術書典オンラインマーケット)(上記画像リンク先と同じ)]]*

    - 初版発行日: 2026/04/11 (技術書典20)
    - 4x5cm程のキーホルダーサイズの本です。
    - 人間をハードウェアとして、その上で動くOSとなっています。
    - この本に書かれた通りに読者が振る舞うことで成り立ちます。
    - 紙とペンを手元に用意し、例えば「$を書く」という指示に従うことで、シェルのプロンプト表示が成立する、といった具合です。
    - 追加・訂正情報
      - 書かれている通りに読み進めるだけだと、永久にキーボード入力待ちになってしまいます。適当なタイミングで「[キーボード割込](P.22)」を読んでキーボード割り込みを起こしてください。
      - P.27の「元の次のページへ戻る」は、KBCバッファが空でない場合もここのページにたどり着いたら元の次のページへ戻るようにしてください。
      - P.29の「元の次のページへ戻る」も、値が文字の場合もここで元の次のページへ戻るようにしてください。

*** 人生ゲームOS
    [[file:golos-map.png][file:golos-map-x241.png]]
    | [[file:golos-cards-1.png][file:golos-cards-1-x241.png]] | [[file:golos-cards-2.png][file:golos-cards-2-x241.png]] |
    | [[file:golos-cards-3.png][file:golos-cards-3-x241.png]] | [[file:golos-cards-4.png][file:golos-cards-4-x241.png]] |
    → *PDF版([[file:golos-map-a2.pdf][マップ(A2版)]],[[file:golos-map-a3.pdf][マップ(A3分割版)]],[[file:golos-cards.pdf][カード類]])*

    - 最初の公開日: 2026/03/29
    - 3/26(木)〜3/29(日)の[[https://www.ipa.go.jp/jinzai/security-camp/2025/connect/index.html][セキュリティ・キャンプ2026コネクト]]の[[https://www.ipa.go.jp/jinzai/security-camp/2025/connect/os.html][OSクラス]]のプロデューサー兼講師として行った講義の制作物です。
    - 様々な方々にOSに親しんでもらうことを目指し、このようなボードゲームを作ってみました！
    - プレイヤーは脆弱な状態のOSで、左上から開始します。
    - すごろくのようですが、勝敗は着順ではなくゴール時の⭐️の数で決まります。
    - ⭐️は何かを達成したりするともらえ、セキュリティインシデントで失います。
    - ただし、対応するパッチを獲得していれば失わないで済む、という感じです。
    - マイナス⭐️は、所持⭐️が0のときにマイナス⭐️のマスに止まったとき用です。

*** 単純PC環境
    [[https://yuma.ohgami.jp/spe/][file:spe_20260211_cover.png]]
    → *プラウザ上でプレイ([[https://yuma.ohgami.jp/spe/][上記画像リンク先と同じ]],[[https://plicy.net/GamePlay/223166][PLiCy]])*

    - 最初の公開日: 2026/02/11
    - PC環境を極力単純化したシミュレーターのようなものです。
    - 「動くブロック図（食べられる絵に描いた餅）」というコンセプトで、教科書に登場するようなコンピュータを単純化したブロック図を、実際に動作する形で表現しています。
    - 操作方法など詳しくは[[https://yuma.ohgami.jp/spe-doc/][こちらのドキュメント]]をご覧ください。

*** RPGOS NPC独自アセンブリプログラミング
    [[file:RPGOS_NPC_original_asm_program.pdf][file:rnoap_cover.png]]
    → *PDF版([[file:RPGOS_Book.pdf][PDFファイル直リンク(表紙画像リンク先と同じ)]])*

    - 初版発行日: 2025/10/26 (第十二回技術書同人誌博覧会)
    - 「RPGのような世界で動くOS」として制作している「RPGOS」のNPC（Non Player Character）を、独自な言語でプログラミングできるようにした「NPCプログラミング環境」を紹介し、実際に簡単なプログラミングを行ってみます。
    - なお、本作の表紙・裏表紙はグラフィックデザイナーのくろあんず様（X：[[https://x.com/B1ackApric0t][@B1ackApric0t]]）に制作していただきました！へにゃぺんてとしては初の試みで記念すべき1冊です！
    - 本書で紹介している「NPCプログラミング環境」は以下で公開しています。
      - https://plicy.net/GamePlay/209620
    - また、サンプルリポジトリは以下の通りです。
      - https://github.com/cupnes/rpgos_npc_programming_samples

*** RPGのような世界で動くOSの本
    [[file:RPGOS_Book.pdf][file:rob_cover.png]]
    → *PDF版([[file:RPGOS_Book.pdf][PDFファイル直リンク(表紙画像リンク先と同じ)]],[[https://techbookfest.org/product/emuYWSg2tEfBAGVcpWQmpG][技術書典オンラインマーケット]])*

    - 初版発行日: 2025/05/31 (技術書典18)
    - RPGのような世界で動くOS（RPGOS）の現時点（v0.3）の実装や考えを解説した同人誌です。

*** RPGOS v0.3
    [[https://plicy.net/GamePlay/202689][file:rpgos03_cover.png]]
    → *[[https://plicy.net/GamePlay/202689][プラウザ上でプレイ(PLiCy)(上記画像リンク先と同じ)]]*

    - 最初の公開日: 2025/05/26
    - RPGのような世界の上で動作するOSです。
    - まだまだ開発版であり、OSとしてできることも唯一存在するファイルであるHELLO.TXTを見ることくらいです。。
    - ファイルシステムがまだ無い時のものですが、このソフトを紹介する動画をYouTubeに上げています。
      - https://youtu.be/uwrny-POiBU

*** セガサターンタイル描画のうすい本
    [[file:Understanding-the-Sega-Saturn5.pdf][file:uss5_cover.png]]
    → *PDF版([[file:Understanding-the-Sega-Saturn5.pdf][PDFファイル直リンク(表紙画像リンク先と同じ)]],[[https://techbookfest.org/product/vjpRvEb9QcyEpFp2U23YW2][技術書典オンラインマーケット]])*

    - 初版発行日: 2024/11/02 (技術書典17)
    - セガサターンに搭載された画面描画用のICが持つ「タイル」という描画方式について、エミュレータで動作する小さなサンプルを参考にしつつ、エミュレータ「[[https://yabause.org/][Yabause]]」のソースコードを読んで理解します。

*** DaisyOS GB v0.4
    [[https://yohgami.itch.io/daisyos-gb-v04][file:dog040_cover.png]]
    → *[[https://yohgami.itch.io/daisyos-gb-v04][プラウザ上でプレイ(itch.io)(上記画像リンク先と同じ)]]*
    ...
    - より詳しくは[[file:intro-dog04.pdf][こちらのポスター(PDF)]]をご覧ください

*** へにゃぺんて活動報告2024年春号
    [[file:Henyapente-Activity-Report-2024-Spring.pdf][file:har24sp-cover.png]]
    → *PDF版([[file:Henyapente-Activity-Report-2024-Spring.pdf][PDFファイル直リンク(表紙画像リンク先と同じ)]])*
...
*** Daisyworld DEMO - DaisyOS GB v0.3
    [[https://yohgami.itch.io/daisyworld-demo-daisy-os-v030][file:dog030_cover.png]]
    → *[[https://yohgami.itch.io/daisyworld-demo-daisy-os-v030][プラウザ上でプレイ(itch.io)(上記画像リンク先と同じ)]]*

    → *[[https://yohgami.itch.io/daisyos-dev][開発版(itch.io)]]*
...
*** よりシンプルなバイナリ生物学の本
    [[file:Simpler-Binary-Biology-Book.pdf][file:sbbb-cover.png]]
    → *PDF版([[file:Simpler-Binary-Biology-Book.pdf][PDFファイル直リンク(表紙画像リンク先と同じ)]],[[https://techbookfest.org/product/wwmmiQYtue5QT29Ye8mtgm][技術書典オンラインマーケット]])*
...
*** SimHでPDP-7ベアメタルプログラミング
    [[file:PDP7-BareMetal-Programming-with-SimH.pdf][file:pbps-cover.png]]
    → *PDF版([[file:PDP7-BareMetal-Programming-with-SimH.pdf][PDFファイル直リンク(表紙画像リンク先と同じ)]],[[https://techbookfest.org/product/bNt2JRY8VcGgPbgJHjD2yA][技術書典オンラインマーケット]])　　　　　紙版([[https://channel.beep-shop.com/products/detail/36029][BEEP]])*
    ...
    - 追加・訂正情報
      - [[https://scrapbox.io/simh-pdp7/][Scrapboxに追加の情報などをまとめています]]
      - [[https://www.ipa.go.jp/jinzai/security-camp/2023/next/program_list.html#2023n5][「セキュリティ・ネクストキャンプ2023」にて同タイトルの講義を行います！]]
      - 1.1節でPDP-7のリリース年を「1965年」と書いておりましたが正しくは「1964年」であるようです
	- 「1965年」というのは[[https://ja.wikipedia.org/wiki/PDP-7][Wikipediaの記事]]を見てそのように認識していました
	...
	- LAW命令について詳しくは[[https://scrapbox.io/simh-pdp7/LAW%E5%91%BD%E4%BB%A4][こちら]]をご覧ください
      - 4.2節の「表4.3: Type 340命令フォーマット紹介 : パラメータモード」の「(ただし現状のOpen-SimHでは特に意味はない)」の脚注で「ty340_lp_int関数は中身が空あるいはprintf()するだけ」と書いていた件について
	- [[https://github.com/open-simh/simh/blob/09899c18/display/tst340.c#L177-L180][「printf()するだけ」の方の実装はdisplay/tst340.cというファイルの中にあります]]
	- ファイル名からも分かる通り、これはテストやデバッグの際にリンクされるものなので、通常は使用されません
	- そのため、「ty340_lp_int関数は中身が空あるいはprintf()するだけ」と書いていたのは一部誤りで、通常は「[[https://github.com/open-simh/simh/blob/09899c18/PDP18B/pdp18b_dpy.c#L112-L115][ty340_lp_int関数は中身が空]]」です

*** DaisyOS(仮) v0.1.0
    [[https://yohgami.booth.pm/items/4430097][file:dog010_cover.png]]
    → *[[https://yohgami.booth.pm/items/4430097][ROM版(BOOTH)(上記画像リンク先と同じ)]]*
    ...
    - それにより、実行バイナリが持つ機械語の命令列を、細胞分裂時の突然変異による進化で目的の形へ作り変える事ができます
      - このGB実装では突然変異は一部分のみ
    - 詳しくは[[file:dog010_poster.pdf][こちらの紹介ポスター(PDF)]]をご覧ください

*** へにゃぺんて活動報告2022年秋号
    [[https://yohgami.booth.pm/items/4303745][file:har22a_cover.png]]
    → *[[https://yohgami.booth.pm/items/4303745][ROM版(BOOTH)(上記画像リンク先と同じ)]]*
...
*** 自作OS系個人サークル「へにゃぺんて」で作ったものと、そのとき考えていたこと（さくらのナレッジ）
    以降の同人誌/同人作品については、さくらのナレッジにてまとめ記事を執筆させていただきました！
     - [[https://knowledge.sakura.ad.jp/32957/][前編(「OS5」から「遺伝的MBR」まで)]]
     - [[https://knowledge.sakura.ad.jp/33073/][後編(「x86(64ビット)機械語開発」から「AMADO」や「セガサターンエミュレータコード解説」まで)]]

*** セガサターン自作シンセサイザー読本
    [[file:Understanding-the-Sega-Saturn4.pdf][file:uss4_cover.jpg]]
    → *PDF版([[file:Understanding-the-Sega-Saturn4.pdf][PDFファイル直リンク(表紙画像リンク先と同じ)]],[[https://techbookfest.org/product/ityGWSqTutAfH2th5qND1j][技術書典オンラインマーケット]])　　　　　紙版([[https://channel.beep-shop.com/products/detail/26761][BEEP]])*

    - 初版発行日: 2022/08/13 (コミックマーケット100)
    - [[https://youtube.com/playlist?list=PLyRFvsy-N_GQKmC8_yqhvtLsnxlyxn1Lp][セガサターン自作シンセサイザー]]についての技術解説本です
    - セガサターンの音源ICがシンセサイザーだって作れるほどの機能を持っていることをエミュレータのコードで解説しています
    - 追加・訂正情報
      - 本書の中で"MC68EC00"と書いている箇所は全て誤記で、正しくは"MC68EC000"でした

*** セガサターンとMIDIで通信する本
    [[file:Communicating-Sega-Saturn-MIDI.pdf][file:cssm_cover.jpg]]
    → *PDF版([[file:Communicating-Sega-Saturn-MIDI.pdf][PDFファイル直リンク(表紙画像リンク先と同じ)]],[[https://techbookfest.org/product/5326410916823040][技術書典オンラインマーケット]])　　　　　紙版([[https://channel.beep-shop.com/products/detail/19770][BEEP]],[[https://ecs.toranoana.jp/tora/ec/item/040030969615/][とらのあな]],[[https://www.melonbooks.co.jp/detail/detail.php?product_id=1372235][メロンブックス]])*
    ...
    - 追加情報
      - [[https://akiba-pc.watch.impress.co.jp/docs/wakiba/find/1391302.html][AKIBA PC Hotline!様でご紹介いただきました！]]

*** セガサターンCDシステムのうすい本
    [[https://techbookfest.org/product/5821234367430656][file:uss2_cover.png]]
    → *[[https://techbookfest.org/product/5821234367430656][PDF版(技術書典オンラインマーケット)(上記画像リンク先と同じ)]]　　　　　紙版([[https://channel.beep-shop.com/products/detail/19322][BEEP]],[[https://ecs.toranoana.jp/tora/ec/item/040030961389/][とらのあな]],[[https://www.melonbooks.co.jp/detail/detail.php?product_id=1178260][メロンブックス]])*
    ...
    - 追加情報
      - [[https://akiba-pc.watch.impress.co.jp/docs/wakiba/find/1387883.html][AKIBA PC Hotline!様でご紹介いただきました！]]

*** エミュレータのコードを読んでわかるセガサターン
    [[https://techbookfest.org/product/5711801452855296][file:uss_cover.png]]
    → *[[https://techbookfest.org/product/5711801452855296][PDF版(技術書典オンラインマーケット)(上記画像リンク先と同じ)]]　　　　　紙版([[https://channel.beep-shop.com/products/detail/13279][BEEP]],[[https://ecs.toranoana.jp/tora/ec/item/040030925359/][とらのあな]],[[https://www.melonbooks.co.jp/detail/detail.php?product_id=1077270][メロンブックス]])*
    ...
    - 追加情報
      - [[https://www.youtube.com/watch?v=2SLFl_i1pL0&t=5758s][「7/15(木)21時-22時 技術書典11開催スペシャル！書籍紹介！」でご紹介いただきました！]]
      - ↑でも指摘いただいていましたがYabauseからforkした「[[https://www.uoyabause.org/][uoYabause]]」の開発が進んでいます
	- ソースコードリポジトリ：https://github.com/devmiyax/yabause
      - [[https://youtu.be/S2aON6wZ40A?t=1375][「刺され！技術書アワード 刺さる部門」のファイナリスト作品にノミネートしました！]]

*** ゲームボーイOS「AMADO」v0.03
    [[https://yohgami.booth.pm/items/2636771][file:amado_v0.03_version.png]]
    → *[[https://yohgami.booth.pm/items/2636771][ROM版(BOOTH)(上記画像リンク先と同じ)]]　　　　　カートリッジ版([[https://channel.beep-shop.com/products/detail/6965][BEEP]],[[https://ecs.toranoana.jp/tora/ec/item/040030876245/][とらのあな]],[[https://www.melonbooks.co.jp/detail/detail.php?product_id=824942][メロンブックス]])*
...
*** ゲームボーイOS「AMADO」で8ビットマシン語入門
    ...
    → *[[https://techbookfest.org/product/5190959769845760][PDF版(技術書典オンラインマーケット)(上記画像リンク先と同じ)]]　　　　　紙版([[https://channel.beep-shop.com/products/detail/7866][BEEP]],[[https://ecs.toranoana.jp/tora/ec/item/040030888063/][とらのあな]],[[https://www.melonbooks.co.jp/detail/detail.php?product_id=806410][メロンブックス]])*
    ...
    - 追加情報
      - [[https://www.youtube.com/watch?v=RZCtWfn5wpU&t=3455s][「【技術に出会える】 技術書典10スペシャルオンラインイベント - 書籍紹介！」でご紹介いただきました！]]
      - [[https://akiba-pc.watch.impress.co.jp/docs/wakiba/find/1308961.html][AKIBA PC Hotline!様でご紹介いただきました！]]
      - [[https://www.youtube.com/watch?v=1vUb2ffTBr4&t=1516s][「刺され！技術書アワード 刺さる部門」のファイナリスト作品にノミネートしました！]]

*** へにゃぺんて活動報告2020年夏号(PDF版)
    [[file:henyapente_activity_report_2020_summer.pdf][file:har2sp_cover.png]]
    → *PDF版([[file:henyapente_activity_report_2020_summer.pdf][PDFファイル直リンク(表紙画像リンク先と同じ)]],[[https://techbookfest.org/product/5998833303552000][技術書典オンラインマーケット]])*
...
*** シェルスクリプトでゲームボーイプログラミング入門
    ...
    → *[[file:GB-Programming-with-Shell-Script.pdf][PDF版(表紙画像リンク先と同じ)]]　　　　　[[file:GB-Programming-with-Shell-Script][HTML版]]　　　　　紙版([[https://channel.beep-shop.com/products/detail/3048][BEEP]],[[https://ecs.toranoana.jp/tora/ec/item/040030828703/][とらのあな]],[[https://www.melonbooks.co.jp/detail/detail.php?product_id=821036][メロンブックス]])*
	...
	- [[https://w.atwiki.jp/gbspec/][GB Spec - atwiki（アットウィキ）]]

*** バイナリ生成環境「daisy-tools」実験報告
    [[file:Daisy-Tools_Laboratory_Report.pdf][file:dtlr_cover.png]]
    → *[[file:Daisy-Tools_Laboratory_Report.pdf][PDF版(表紙画像リンク先と同じ)]]　　　　　[[file:Daisy-Tools_Laboratory_Report][HTML版]]　　　　　紙版([[https://ecs.toranoana.jp/tora/ec/item/040030816295/][とらのあな]],[[https://www.melonbooks.co.jp/detail/detail.php?product_id=821037][メロンブックス]])*
    ...
    - 追加情報
      - [[https://www.ipa.go.jp/jinzai/camp/2022/next2022_program_list.html#list_next5][「セキュリティ・ネクストキャンプ2022 オンライン」にて、バイナリ生物学と本書に関する講義を行いました！]]

*** バイナリ生物学入門
    [[file:Intelligent-Life-in-the-Binary.pdf][file:ilb_cover.png]]
    → *[[file:Intelligent-Life-in-the-Binary.pdf][PDF版(表紙画像リンク先と同じ)]]　　　　　[[file:Intelligent-Life-in-the-Binary][HTML版]]　　　　　紙版([[https://ecs.toranoana.jp/tora/ec/item/040030802408/][とらのあな]],[[https://www.melonbooks.co.jp/detail/detail.php?product_id=821038][メロンブックス]])*
    ...
    - 追加情報
      - [[https://www.ipa.go.jp/jinzai/camp/2022/next2022_program_list.html#list_next5][「セキュリティ・ネクストキャンプ2022 オンライン」にて、本書とdaisy-toolsに関する講義を行いました！]]

*** 作って分かる！x86_64機械語入門
    [[file:Introduction-to-x86_64-Machine-Language.pdf][file:ix86ml_cover.png]]
    → *[[file:Introduction-to-x86_64-Machine-Language.pdf][PDF版(表紙画像リンク先と同じ)]]　　　　　[[file:Introduction-to-x86_64-Machine-Language][HTML版]]　　　　　紙版([[https://ecs.toranoana.jp/tora/ec/item/040030802403/][とらのあな]],[[https://www.melonbooks.co.jp/detail/detail.php?product_id=821039][メロンブックス]])*

    - 初版発行日: 2019/09/22 ([[*2019/09/22: 技術書典7][技術書典7]])
...
*** フルスクラッチで作る!x86_64自作OS パート5 てっとりばやくマルチコア
    ...
    - 初版発行日: 2019/08/12 ([[*2019/08/12: コミックマーケット96][コミックマーケット96]])
...
*** フルスクラッチで作る!x86_64自作OS パート4 ぼくらのイーサネットフレーム!
    ...
    - 初版発行日: 2019/04/14 ([[*2019/04/14: 技術書典6][技術書典6]])
    - ついにNICドライバを実装！
...
*** フルスクラッチで作る!x86_64自作OS パート3 システムコールの薄い本
    ...
    - 初版発行日: 2018/12/30 ([[*2018/12/30: コミックマーケット95][コミックマーケット95]])
...
*** 自作OS自動化のPoCとしての遺伝的MBR
    ...
    - 初版発行日: 2018/10/08 ([[*2018/10/08: 技術書典5][技術書典5]])
...
*** フルスクラッチで作る!UEFIベアメタルプログラミング
    ...
    - [[https://kagurazakakotori.github.io/ubmp-cn/][実は有志の方による中国語（簡体字）への翻訳版があります]]
...
** 発表情報
*** STARTED 2026/06/13-2027/03/07: 2026年度 SecHack365 学習駆動コース 大神ゼミ
    - 2026年度の[[https://sechack365.nict.go.jp/][SecHack365]] [[https://sechack365.nict.go.jp/course/#c02][学習駆動コース]]にて、私のゼミが開講されます！
    - 学習駆動コースや私のゼミについて詳しくは以下もご覧ください。
      - https://kozos.jp/sechack365/

*** DONE 2026/03/26-29: セキュリティ・キャンプ2026コネクト
    - 3/26(木)〜3/29(日)の[[https://www.ipa.go.jp/jinzai/security-camp/2025/connect/index.html][セキュリティ・キャンプ2026コネクト]]で[[https://www.ipa.go.jp/jinzai/security-camp/2025/connect/os.html][OSクラス]]のプロデューサー兼講師として以下の講義を行いました
      - 『独自なOSコンテンツ制作 OSの理解を広げ、セキュリティ意識向上を目指す』
    - 講義では、エンジニア以外の方々にもOSやセキュリティに親しめるコンテンツとして以下のボードゲームを制作しました
      [[file:golos-map.png][file:golos-map-x241.png]]
      | [[file:golos-cards-1.png][file:golos-cards-1-x241.png]] | [[file:golos-cards-2.png][file:golos-cards-2-x241.png]] |
      | [[file:golos-cards-3.png][file:golos-cards-3-x241.png]] | [[file:golos-cards-4.png][file:golos-cards-4-x241.png]] |
      → *PDF版([[file:golos-map-a2.pdf][マップ(A2版)]],[[file:golos-map-a3.pdf][マップ(A3分割版)]],[[file:golos-cards.pdf][カード類]])*
...
*** DONE 2025/10/25: オープンソースカンファレンス2025 Tokyo/Fall
    - 10/25(土)の[[https://event.ospn.jp/osc2025-fall/][オープンソースカンファレンス2025 Tokyo/Fall]]で以下の発表を行いました
      - ステージ企画「Linux デスクトップ見せて」内で、自身が使用しているThinkPad + Debian + awesome環境を紹介
	- スライド無し
      - ステージ企画「ライトニングトーク」にて「RPGOS NPC独自アセンブリプログラミング」というタイトルでLT
	- [[https://speakerdeck.com/cupnes/rpgos-npcdu-zi-asenburipuroguramingu][スライド資料(Speaker Deck)]]

*** DONE 2025/04/26: Open Source un-Conference 2025 Kawagoe
    - 4/26(土)の[[https://koedolug.connpass.com/event/345457/][Open Source un-Conference 2025 Kawagoe]]でLT発表しました
    - LTタイトル：RPGOS(仮)進捗紹介
      - [[https://speakerdeck.com/cupnes/rpgos-jia-jin-bu-shao-jie][スライド資料(Speaker Deck)]]

*** DONE 2025/02/22: オープンソースカンファレンス2025 Tokyo/Spring
    - [[https://event.ospn.jp/osc2025-spring/][オープンソースカンファレンス2025 Tokyo/Spring]]の2日目(2/22(土))の[[https://event.ospn.jp/osc2025-spring/session/2017030][ライトニングトーク＆閉会式]]でLT発表しました
    - タイトル：へにゃぺんて新作OSのご紹介
      - [[https://speakerdeck.com/cupnes/heniyapentexin-zuo-osnogoshao-jie][スライド資料(Speaker Deck)]]

*** DONE 2025/01/18: 小江戸らぐ 1月のオフな集まり(第270回)
    - 1/18(土)の[[https://koedolug.connpass.com/event/341449/][小江戸らぐ 1月のオフな集まり(第270回)]]で発表しました
    - タイトル：最近の自作OSネタ
      - [[https://speakerdeck.com/cupnes/zui-jin-nozi-zuo-osneta][スライド資料(Speaker Deck)]]

*** DONE 2025/01/17: レトロゲーム勉強会#11
    - 1/17(金)の[[https://retrog.connpass.com/event/323836/][レトロゲーム勉強会#11]]でLT発表しました
    - LTタイトル：セガサターンのタイル描画機能を試す
      - [[https://speakerdeck.com/cupnes/segasatannotairumiao-hua-ji-neng-woshi-su][スライド資料(Speaker Deck)]]

*** DONE 2024/11/02: openSUSE.Asia Summit 2024
    - [[https://events.opensuse.org/conferences/oSAS24][openSUSE.Asia Summit 2024]]の1日目(11/2)に「[[https://events.opensuse.org/conferences/oSAS24/program/proposals/4778][The OS Theory and Design Based on Biological Concepts]]」というタイトルで発表しました
    - 資料などは上記のセッションページをご覧ください

*** DONE 2024/06/28: レトロゲーム勉強会#10
    - 6/28(金)の[[https://retrog.connpass.com/event/308272/][レトロゲーム勉強会#10]]でLT発表しました
    - LTタイトル：最近のGB向け独自OS活動について
      - [[https://www.slideshare.net/slideshow/gb-os-10/269952249][スライド資料(SlideShare)]]

*** DONE 2024/04/20: Open Source UN-Conference 2024 Kawagoe
    - 4/20(土)の[[https://koedolug.connpass.com/event/310831/][Open Source UN-Conference 2024 Kawagoe]]でLT発表しました
    - LTタイトル：独自OS「DaisyOS GB」の紹介
      - [[https://www.slideshare.net/slideshow/open-source-unconference-2024-kawagoe-osdaisyos-gb/267390613][スライド資料(SlideShare)]]

*** DONE 2024/03/10: オープンソースカンファレンス2024 Tokyo/Spring
    - 3/10(日)の[[https://event.ospn.jp/osc2024-spring/][オープンソースカンファレンス2024 Tokyo/Spring]]の『OSC20年特別企画「私とOSC」』でLT発表しました

*** DONE 2024/01/19: レトロゲーム勉強会#09
    - 1/19(金)の[[https://retrog.connpass.com/event/291020/][レトロゲーム勉強会#09]]でLT発表しました
    - LTタイトル：Daisy OSでデイジーワールド！
      - [[https://www.slideshare.net/slideshows/daisy-os/265428422][スライド資料(SlideShare)]]

*** DONE 2023/12/03: レトロクリエイターズ2023
    - 12/3(日)の[[https://retrocreators.wixsite.com/event][レトロクリエイターズ2023]]でサークルと作品について発表しました
    - タイトル：へにゃぺんてサークル紹介
      - [[https://yohgami.booth.pm/items/5306216][使用したGBソフトのROMファイル(BOOTH)]]

*** DONE 2023/10/21: オープンソースカンファレンス2023 Tokyo/Fall
    - 10/21(土)の[[https://event.ospn.jp/osc2023-fall/][オープンソースカンファレンス2023 Tokyo/Fall]]で[[https://event.ospn.jp/osc2023-fall/session/1131188][LT発表しました]]
    - LTタイトル：バイナリ生物学でデイジーワールド
      - [[https://www.slideshare.net/yarakawa/ss-ea20][スライド資料(SlideShare)]]

*** DONE 2023/09/30: オープンソースカンファレンス2023 Online/Fall
    - 9/30(土)の[[https://event.ospn.jp/osc2023-online-fall/][オープンソースカンファレンス2023 Online/Fall]]で[[https://event.ospn.jp/osc2023-online-fall/session/1147807][LT発表しました]]
    - LTタイトル：OSC2023 Tokyo/Fall展示内容(予定)と技術書典15向け新刊(執筆中)のご紹介
      - [[https://www.slideshare.net/yarakawa/osc2023-tokyofall15][スライド資料(SlideShare)]]

*** DONE 2023/09/02: セキュリティ・キャンプアフターイベント
    - 9/2(土)のセキュリティ・キャンプアフターイベントでLT発表しました
    - LTタイトル：去年「バイナリ生物学」で今年「PDP-7」だったのはなぜなのか？
      - [[https://www.slideshare.net/yarakawa/pdp7][スライド資料(SlideShare)]]

*** DONE 2023/08/07-11: セキュリティ・ネクストキャンプ2023
    - [[https://www.ipa.go.jp/jinzai/security-camp/2023/next/][セキュリティ・ネクストキャンプ2023]]にて、「[[https://www.ipa.go.jp/jinzai/security-camp/2023/next/program_list.html][SimHでPDP-7ベアメタルプログラミング]]」というタイトルで2コマ(スケジュールN5、N8)の講義を行いました
    - 講義資料は[[https://scrapbox.io/simh-pdp7/%E3%82%B9%E3%83%86%E3%83%83%E3%83%97%E3%83%BB%E3%83%90%E3%82%A4%E3%83%BB%E3%82%B9%E3%83%86%E3%83%83%E3%83%97%E3%81%A7PDP-7%E3%82%B9%E3%83%A9%E3%82%A4%E3%83%89%E3%82%B7%E3%83%A7%E3%83%BC][こちら(Scrapbox)]]

*** DONE 2023/07/21: レトロゲーム勉強会#08
    - 7/21(金)の[[https://retrog.connpass.com/event/272131/][レトロゲーム勉強会#08]]でLT発表しました
    - LTタイトル：60年代ゲームハードPDP-7のご紹介
      - [[https://www.slideshare.net/yarakawa/60pdp7][スライド資料(SlideShare)]]

*** DONE 2023/06/17: オープンソースカンファレンス2023 Online/Hokkaido
    - 6/17(土)の[[https://event.ospn.jp/osc2023-online-do/][オープンソースカンファレンス2023 Online/Hokkaido]]で[[https://event.ospn.jp/osc2023-online-do/session/970590][LT発表しました]]
    - LTタイトル：来週の展示内容紹介
      - [[https://www.slideshare.net/yarakawa/ss-258773686][スライド資料(SlideShare)]]

*** DONE 2023/03/11: オープンソースカンファレンス2023 Online/Spring
    - 3/11(土)の[[https://event.ospn.jp/osc2023-online-spring/][オープンソースカンファレンス2023 Online/Spring]]で[[https://event.ospn.jp/osc2023-online-spring/session/816638][LT発表しました]]
    - LTタイトル：simhでPDP-7ベアメタルプログラミング
      - [[https://github.com/cupnes/sh_pdp7_test/releases/tag/osc23on][使用したPDP-7プログラムを生成するスクリプトのソースコード(GitHub)]]

*** DONE 2023/01/13: レトロゲーム勉強会#07
    - 1/13(金)の[[https://retrog.connpass.com/event/252373/][レトロゲーム勉強会#07]]でLT発表しました
    - LTタイトル：DaisyOS(仮)のご紹介
      - [[https://yohgami.booth.pm/items/4480971][使用したGBソフトのROMファイル(BOOTH)]]
      - [[https://www.slideshare.net/yarakawa/daisyos][GBソフトのスライド部分の元データをPDF化したもの(SlideShare)]]
      - [[https://github.com/cupnes/daisy-os-gb/releases/tag/v0.2.0][ソースコード(GitHub)]]

*** DONE 2022/11/26: オープンソースカンファレンス2022 Online/Fukuoka
    - 11/26(土)の[[https://event.ospn.jp/osc2022-online-fukuoka/][オープンソースカンファレンス2022 Online/Fukuoka]]で[[https://event.ospn.jp/osc2022-online-fukuoka/session/709281][LT発表しました]]
    - LTタイトル：『へにゃぺんて』のこれまでを振り返るブログ記事の紹介
      - [[https://www.slideshare.net/yarakawa/ss-254504915][スライド資料(SlideShare)]]
      - [[https://www.youtube.com/watch?v=V3RxsPPb_QA&t=2318s][録画(YouTube)]]
      - ※ 11/19の小江戸らぐでの10分程度の発表を5分にまとめたものです(スライド資料としてはほとんど同じ)

*** DONE 2022/11/19: 小江戸らぐ 11月のオフな集まり(第244回)
    - 11/19(土)の[[https://koedolug.connpass.com/event/262814/][小江戸らぐ 11月のオフな集まり(第244回)]]で発表しました
    - 発表タイトル：「へにゃぺんて」のこれまでを振り返るブログ記事の紹介
      - [[https://www.slideshare.net/yarakawa/ss-254315527][スライド資料(SlideShare)]]

*** DONE 2022/08/09-10: セキュリティ・ネクストキャンプ2022 オンライン
    - [[https://www.ipa.go.jp/jinzai/camp/2022/next2022_index.html][セキュリティ・ネクストキャンプ2022 オンライン]]にて、「[[https://www.ipa.go.jp/jinzai/camp/2022/next2022_program_list.html#list_next5][バイナリ生物学入門]]」というタイトルで2コマ(スケジュールN5、N9)の講義を行いました
    - 講義で使用したスライド資料はこちら↓(Slideshare)
      - [[https://www.slideshare.net/yarakawa/2022-n5][N5 8/9(火) 15:30〜17:30]]
      - [[https://www.slideshare.net/yarakawa/2022-n9][N9 8/10(水) 18:30〜20:30]]

*** DONE 2022/06/25: オープンソースカンファレンス2022 Online/Hokkaido
    - 6/25(土)の[[https://event.ospn.jp/osc2022-online-do/][オープンソースカンファレンス2022 Online/Hokkaido]]で[[https://event.ospn.jp/osc2022-online-do/session/591172][LT発表しました]]
    - LTタイトル：バイナリ生成環境『daisy-tools』のご紹介
      - [[https://www.slideshare.net/yarakawa/daisytools][スライド資料(SlideShare)]]
      - [[https://youtu.be/bYdwibcSHLE?t=441][録画(YouTube)]]

*** DONE 2022/06/23: レトロゲーム勉強会#06
    - 6/23(木)の[[https://retrog.connpass.com/event/249578/][レトロゲーム勉強会#06]]でLT発表しました
    - LTタイトル：セガサターンで動く自作シンセサイザーについて
      - [[https://github.com/cupnes/sh_ss_synth_retrogstudy_06][スライド資料(ROMイメージを生成するスクリプト)]]
      - [[https://youtu.be/nmoKBJfT9fQ][リハーサル時の録画(YouTube)]]

*** DONE 2022/03/12: オープンソースカンファレンス2022 Online/Spring
    - 3/12(土)の[[https://event.ospn.jp/osc2022-online-spring/][オープンソースカンファレンス2022 Online/Spring]]で[[https://event.ospn.jp/osc2022-online-spring/session/511253][LT発表しました]]
    - LTタイトル：セガサターンでシンセ作り始めてみた
      - [[https://youtu.be/lDWpmHC7HRw][録画(YouTube)]]

*** DONE 2022/01/29: オープンソースカンファレンス2022 Online/Osaka
    - 1/29(土)の[[https://event.ospn.jp/osc2022-online-osaka/][オープンソースカンファレンス2022 Online/Osaka]]で[[https://event.ospn.jp/osc2022-online-osaka/session/508722][LT発表しました]]
    - LTタイトル：技術書典12新刊『セガサターンとMIDIで通信する本』の紹介
      - [[https://youtu.be/wPjeK2bIvwE?t=393][録画(YouTube)]]

*** DONE 2021/10/23: オープンソースカンファレンス2021 Online/Fall
    - 10/23(土)の[[https://event.ospn.jp/osc2021-online-fall/][オープンソースカンファレンス2021 Online/Fall]]の[[https://event.ospn.jp/osc2021-online-fall/session/456694][『OSC200回記念ライトニングトーク「OSCと私」』]]でLT発表しました
    - LTタイトル：OSCとみなさんのおかげでした

*** DONE 2021/08/29: オープンソースカンファレンス2021 Online/Aizu
    - 8/29(日)の[[https://ospn.connpass.com/event/220482/][オープンソースカンファレンス2021 Online/Aizu]]でLT発表しました
    - LTタイトル：セガサターンマシン語プログラミングの紹介
      - [[https://www.slideshare.net/yarakawa/ss-250079982][スライド資料(SlideShare)]]

*** DONE 2021/08/28: オープンデベロッパーズカンファレンス2021 Online
    - 8/28(土)の[[https://event.ospn.jp/odc2021-online/][オープンデベロッパーズカンファレンス2021 Online]]で[[https://event.ospn.jp/odc2021-online/session/396084][セミナー発表しました]]
    - セミナータイトル：ハードの作りで振り返るセガサターン
      - [[https://www.slideshare.net/yarakawa/ss-250068281][スライド資料(SlideShare)]]
      - [[https://youtu.be/jbvH9HgsEP8][録画(YouTube)]]

*** DONE 2021/08/11: レトロゲーム勉強会#05
    - 8/11(水)の[[https://retrog.connpass.com/event/216985/][レトロゲーム勉強会#05]]でLT発表しました
    - LTタイトル：エミュレータのコードを読んでわかるセガサターン
      - [[https://www.slideshare.net/yarakawa/ss-250003183][スライド資料(SlideShare)]]

*** DONE 2021/06/26: オープンソースカンファレンス2021 Online/Hokkaido
    - 6/26(土)の[[https://event.ospn.jp/osc2021-online-do/][オープンソースカンファレンス2021 Online/Hokkaido]]で[[https://event.ospn.jp/osc2021-online-do/session/349614][LT発表しました]]
    - LTタイトル：エミュレータのコードを読んでわかる「セガサターン」
      - [[https://www.slideshare.net/yarakawa/ss-249505301][スライド資料(SlideShare)]]
      - [[https://youtu.be/FIFtjMqEuZU?t=1775][録画(YouTube)]]

*** DONE 2021/04/18: 第25回 自作OSもくもく会オンライン
    - 4/18(日)の[[https://osdev-jp.connpass.com/event/209518/][第25回 自作OSもくもく会オンライン]]で発表しました
    - 発表タイトル：シェルスクリプトでセガサターンマシン語ベアメタルプログラミング
      - [[https://www.slideshare.net/yarakawa/ss-246356900][スライド資料(SlideShare)]]

*** DONE 2021/04/17: Open Source unConference 2021 Online/Spring
    - 4/17(土)の[[https://ospn.connpass.com/event/208385/][Open Source unConference 2021 Online/Spring]]でLT発表しました
    - LTタイトル：シェルスクリプトでセガサターンマシン語ベアメタルプログラミング
      - [[https://www.slideshare.net/yarakawa/ss-246356900][スライド資料(SlideShare)]]
      - [[https://youtu.be/OrKnhIT5KG8?t=2135][録画(YouTube)]]

*** DONE 2020/12/30: 第23回 自作OSもくもく会オンライン
    - 12/30(水)の[[https://osdev-jp.connpass.com/event/200085/][第23回 自作OSもくもく会オンライン]]で発表しました
    - 発表タイトル：ゲームボーイ向けOSの作り方
      - [[https://www.slideshare.net/yarakawa/os-240719009][スライド資料(SlideShare)]]

*** DONE 2020/10/25: オープンソースカンファレンス2020 Online/Aizu
    - 10/25(日)の[[https://ospn.connpass.com/event/186393/][オープンソースカンファレンス2020 Online/Aizu]]でLT発表しました
    - LTタイトル：メガドラ実機で自作のROMファイルを動かしてみた話
      - スライド資料([[https://www.slideshare.net/yarakawa/rom-238967746][SlideShare]], [[https://github.com/cupnes/megadrive_test/releases/tag/osc_2020_online_aizu][ROMファイル]])
      - [[https://youtu.be/VkXkYu2Uc2Q?t=3603][録画(YouTube)]]

*** DONE 2019/11/24: オープンソースカンファレンス2019 Tokyo/Fall
    - 11/24(日)の[[https://www.ospn.jp/osc2019-fall/][オープンソースカンファレンス2019 Tokyo/Fall]]で[[https://www.ospn.jp/osc2019-fall/modules/eguide/e2.html][LT発表しました]]
    - LTタイトル：「生きたOS」の話
...
**** DONE 2018/10/28: オープンソースカンファレンス2018 Tokyo/Fall
     - 10/28(日)の[[https://www.ospn.jp/osc2018-fall/][オープンソースカンファレンス2018 Tokyo/Fall]]で[[https://www.ospn.jp/osc2018-fall/modules/eguide/e2.html][LT発表しました]]！
...
**** DONE 2017/04/13: 独自OS委員会第一回公聴会
     ...
     - "UEFI向け自作OSの紹介"というタイトルで、[[*poiOS(旧：OS6)][OS6]]の紹介です
     - 発表資料
...
** poiOS(旧：OS6)
   ...
   | *このOSに関する同人誌* | 「[[*フルスクラッチで作る!UEFIベアメタルプログラミング][フルスクラッチで作る!UEFIベアメタルプログラミング]]」,            |
   |                        | 「[[*フルスクラッチで作る!UEFIベアメタルプログラミング パート2][フルスクラッチで作る!UEFIベアメタルプログラミング パート2]]」     |
...
** ゆあOS
   ...
   - 主にカーネル・アプリが新規作成部分で、ブートローダーは[[*poiOS(旧：OS6)][poiOS]]をベースに作成したpoibootを使用
   - UIとして、ゲーム風UIを搭載
   ...
   | *このOSに関する同人誌* | 「[[*フルスクラッチで作る!x86_64自作OS][フルスクラッチで作る!x86_64自作OS]]」,                                                |
   |                        | 「[[*フルスクラッチで作る!x86_64自作OS パート2 ACPIでHPET取得してスケジューラを作る本][フルスクラッチで作る!x86_64自作OS パート2 ACPIでHPET取得してスケジューラを作る本]]」, |
   |                        | 「[[*フルスクラッチで作る!x86_64自作OS パート3 システムコールの薄い本][フルスクラッチで作る!x86_64自作OS パート3 システムコールの薄い本]]」,                 |
   |                        | 「[[*フルスクラッチで作る!x86_64自作OS パート4 ぼくらのイーサネットフレーム!][フルスクラッチで作る!x86_64自作OS パート4 ぼくらのイーサネットフレーム!]]」,          |
   |                        | 「[[*フルスクラッチで作る!x86_64自作OS パート5 てっとりばやくマルチコア][フルスクラッチで作る!x86_64自作OS パート5 てっとりばやくマルチコア]]」                |
...
** AMADO
   ...
   | *このOSに関する同人誌*   | 「[[*シェルスクリプトでゲームボーイプログラミング入門][シェルスクリプトでゲームボーイプログラミング入門]]」,  |
   |                          | 「[[*ゲームボーイOS「AMADO」で8ビットマシン語入門][ゲームボーイOS「AMADO」で8ビットマシン語入門]]」       |
   | *このOSに関する同人作品* | 「[[*ゲームボーイOS「AMADO(仮)」v0.01][ゲームボーイOS「AMADO(仮)」v0.01]]」,                  |
   |                          | 「[[*へにゃぺんて活動報告2020年夏号][へにゃぺんて活動報告2020年夏号]](v0.02)」,             |
   |                          | 「[[*ゲームボーイOS「AMADO」v0.03][ゲームボーイOS「AMADO」v0.03]]」                       |
   ...
   - ゲームボーイソフトが動く一通りのハードで動作確認している様子
     - https://twitter.com/yohgami/status/1344471911619678209
   - 即興で作ったお絵かきソフトで2021年の書き初め
     - https://twitter.com/yohgami/status/1345639602481053696
...
*** GB版
    - カートリッジ写真と説明画像
      - https://twitter.com/yohgami/status/1608670014755966977
    - エミュレータ上での動作デモ
      - 動作の様子
	- https://twitter.com/yohgami/status/1600500889055531008
      - "HELLO"の各文字を生み出す
	- https://twitter.com/yohgami/status/1608732000172781570
    - オマケ的に付けたスライドショー機能
      - エミュレータ上で動作している様子
	- https://twitter.com/yohgami/status/1614627449081561089
      - 実機でスーパーゲームボーイを用いて動作している様子(実機の映像と音声の出力を取り込んだもの)
	- https://twitter.com/yohgami/status/1614636605251399680
      - 実機で動作している様子の写真
	- https://twitter.com/yohgami/status/1614636797572820993

* ベアメタルプログラミング
** UEFIベアメタルプログラミング
   - UEFI+x86_64でのOS自作をフルスクラッチでやれるよう、まずはUEFIの勉強としてベアメタルプログラミングをしています
   - 勉強した結果 => [[*poiOS(旧：OS6)][OS6]] => 同人誌向けに作り直し => poiOS
...
** メガドライブベアメタルプログラミング
   - 作ったプログラムを実機で動作させている様子
     - https://twitter.com/yohgami/status/1319295888443932673
...
*** 脆弱性・セキュリティ
    - [[https://yohgami.hateblo.jp/entry/20180122/1516622132][(自分メモ)Meltdown・SpectreのGoogle Project Zeroの報告内容について]]
...
** AVRマイコン
   ...
   - 自作アーケード基板
     - [[https://twitter.com/yohgami/status/1275799025468370945][カラーバー表示]]
     - [[https://twitter.com/yohgami/status/1309798396132167680][ブロック崩し(未満)]]
     - [[https://github.com/cupnes/avr_ac_sys_board_samples][ソースコード]]
